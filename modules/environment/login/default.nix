  ...
  config = {
    ...
    environment.files = {
      ...
      prootStatic =
        let
          crossCompiledPaths = {
            aarch64-linux = "/nix/store/6rbm0qkxki626jbifabb7zvc6dm4z783-proot-termux-static-aarch64-unknown-linux-android-0-unstable-2026-02-21";
            x86_64-linux = "/nix/store/qdr2zjpbb1b660fbrsnvc50q9mm6b4i6-proot-termux-static-x86_64-unknown-linux-android-0-unstable-2026-02-21";
          };
        in
